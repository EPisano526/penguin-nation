...
function displayQuotesPanel() {
    ...
    let quotesPanel = document.querySelector("#quotesPanel")
    clear("#quotesPanel")
    const quotes = [
    ...
    quotesPanel.innerHTML = quotes[random]
}
...
function displayNewsPanel() {
    ...
    news.forEach(function (element) {
        // add elements to the page (DOM) using the techniques you learned in Module 3 to make the news arraay items appear on the page
        let newsTitle = document.createElement('h3')
        let p = document.createElement('p')
        let readmore = document.createElement('a')

        newsTitle.innerText = element[1] + ' - ' + element[0]
        p.innerText = element[2]
        readmore.setAttribute('href', element[3])
        ...
        newsItems.appendChild(br1)
        newsItems.appendChild(newsTitle)
        newsItems.appendChild(br2)
        newsItems.appendChild(p)
        newsItems.appendChild(readmore)
        newsItems.appendChild(br3)
    })
}
...
function displayFeaturedStudentPanel() {
    ...
    console.log('displayFeaturedStudentPanel')
    ...
    */
    ...
    let studentpicture = document.createElement('img')
    studentpicture.setAttribute('class', 'studentpic rounded mx-auto d-block')
    studentpicture.setAttribute('src', featuredStudents[randomStudent][2])
    featuredStudent.appendChild(studentpicture)

    let studenttitle = document.createElement('h3')
    studenttitle.innerText = featuredStudents[randomStudent][0]
    featuredStudent.appendChild(studenttitle)

    let studentpara = document.createElement('p')
    studentpara.innerText = featuredStudents[randomStudent][1]
    featuredStudent.appendChild(studentpara)
}
...
document.getElementById('theLogo').addEventListener("click", function () {
    stopIntervals(quotesTimer, featuredStudentTimer);
});
